...
func TestInvalidComplement(t *testing.T) {
	fab := new(addon.FuelAccountBalance)
...
func TestFuelAccountInvalidLine(t *testing.T) {
	fab := &addon.FuelAccountBalance{Lines: []*addon.FuelAccountLine{{}}}
	...
	fab.Lines[0].Item = &addon.FuelAccountItem{Price: num.MakeAmount(1, 0)}
			...
			Lines: []*addon.FuelAccountLine{
				{
					...
					Item:     &addon.FuelAccountItem{Price: num.MakeAmount(9091, 2)},
			...
			Lines: []*addon.FuelAccountLine{
				{
					...
					Item:     &addon.FuelAccountItem{Price: num.MakeAmount(12743, 3)},
					Taxes: []*addon.FuelAccountTax{
						{
				...
				},
				{
					...
					Item:     &addon.FuelAccountItem{Price: num.MakeAmount(12709, 3)},
					Taxes: []*addon.FuelAccountTax{
						{
							Category: tax.CategoryVAT,
							Percent:  num.NewPercentage(16, 2),
			...
			Lines: []*addon.FuelAccountLine{
				{
					...
					Item:     &addon.FuelAccountItem{Price: num.MakeAmount(19809, 3)},
					Taxes: []*addon.FuelAccountTax{
						{
							Category: tax.CategoryVAT,
							Percent:  num.NewPercentage(16, 2),
				...
				},
				{
					...
					Item:     &addon.FuelAccountItem{Price: num.MakeAmount(19823, 3)},
					Taxes: []*addon.FuelAccountTax{
						{
							Category: tax.CategoryVAT,
							Percent:  num.NewPercentage(16, 2),
			...
			Lines: []*addon.FuelAccountLine{
				{
					...
					Item:     &addon.FuelAccountItem{Price: num.AmountFromFloat64(ip, 4)},
					Taxes: []*addon.FuelAccountTax{
						{
							Category: tax.CategoryVAT,
	...
	t.Run("example 5", func(t *testing.T) {
		...
		fab := &addon.FuelAccountBalance{
			Lines: []*addon.FuelAccountLine{
				{
					Quantity: num.AmountFromFloat64(q, 3),
					Item:     &addon.FuelAccountItem{Price: num.AmountFromFloat64(ip, 5)},
					Taxes: []*addon.FuelAccountTax{
						{
							Category: tax.CategoryVAT,
							Percent:  num.NewPercentage(int64(vat*1000), 3),
