...
func TestInvalidFoodVouchersLine(t *testing.T) {
	fvc := &addon.FoodVouchers{Lines: []*addon.FoodVouchersLine{{}}}
...
func TestInvalidFoodVouchersEmployee(t *testing.T) {
	fvc := &addon.FoodVouchers{Lines: []*addon.FoodVouchersLine{{Employee: &addon.FoodVouchersEmployee{}}}}
